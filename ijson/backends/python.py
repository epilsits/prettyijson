...
def basic_parse(file, buf_size=BUFSIZE, do_translate=True):
    '''
...
def parse(file, buf_size=BUFSIZE, do_translate=True):
    ...
    '''
    return common.parse(basic_parse(file, buf_size=buf_size, do_translate=do_translate))


def items(file, prefix, do_translate=True):
    '''
    Backend-specific wrapper for ijson.common.items.
    '''
    return common.items(parse(file, do_translate=do_translate), prefix)
